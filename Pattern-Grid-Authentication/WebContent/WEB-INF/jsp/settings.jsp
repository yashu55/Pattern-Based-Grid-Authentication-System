...
<jsp:include  page="footer.jsp" />   
 ...
 <script src="${pageContext.request.contextPath}/resources/javascript/patternlock.js"></script>
 <script>let lock = new PatternLock("#patternHolder", { matrix: [<%=defaultPatternType.getPatternRowSize()%>, <%=defaultPatternType.getPatternColSize()%>] });
</script>
  <script src="${pageContext.request.contextPath}/resources/javascript/patternValidation.js"></script>
